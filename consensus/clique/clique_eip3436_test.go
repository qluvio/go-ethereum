...
func testCliqueEIP3436(t *testing.T, testConfig cliqueEIP3436TestCase) {
	...
	getNextBlockWithSigner := func(chr consensus.ChainReader, parentBlock *types.Block, signerIndex int) *types.Block {
...
func (m *mockChainHeaderReader) GetBlock(hash common.Hash, number uint64) *types.Block {
	panic("implement me")
}
